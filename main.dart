    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final channelKey = channelNames.keys.elementAt(index);
          final displayName = channelNames[channelKey]!;
...
class _ChannelTalkPageState extends State<ChannelTalkPage> {
  ...
  try {
    ...
    for (int i = 0; i < talks.length; i++) {
      ...
      final talkEnd = (i + 1 < talks.length)
    ...
    setState(() {
      ...
      errorMessage = current == null
          ? "Nessun talk in onda al momento."
          : null;
    });
  } catch (e) {
    setState(() {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Speaker: ${talk.speakers}",
                style: const TextStyle(fontSize: 16)),
            const SizedBox(height: 8),
            Text(talk.description,
                style: const TextStyle(fontSize: 15, color: Colors.black87)),
            const SizedBox(height: 8),
            Text("📅 ${talk.schedule_time}",
                style:
...
class AllTalksPage extends StatelessWidget {
  final String channel;
  final String displayName;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Programmazione: $displayName"),
        backgroundColor: Colors.blue,
      ),
      body: FutureBuilder<List<Talk>>(
        future: get_Talks_By_Channel(channel, 100),
        builder: (context, snapshot) {
          ...
          final upcomingTalks = (currentIndex >= 0 && currentIndex + 1 < talks.length)
          ...
          final allToDisplay = [
            if (currentTalk != null) currentTalk,
            ...upcomingTalks,
          ];
